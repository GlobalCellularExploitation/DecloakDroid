...
import com.decloakdroid.logging.Logger;
...
public class LoggerWrap extends IntroStringHelper {
	...
	public void disableDBlogger() { _l.disableDBlogger(); }
	
	public void enableDBlogger() {
		_l.enableDBlogger();
	}

	public void disableFilelogger() { _l.disableFilelogger(); }

	public void enableFilelogger() { _l.enableFilelogger(); }
