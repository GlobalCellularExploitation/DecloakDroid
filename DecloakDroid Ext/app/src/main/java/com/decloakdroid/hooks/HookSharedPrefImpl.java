package com.decloakdroid.hooks;
import com.decloakdroid.ext.IntroHook;
...
class Intro_GET_SHARED_PREF extends IntroHook { 
	public void execute(Object... args) {		
			...
			try {
				...
				// Log.w("cloakdroidLog", "error in Intro_GET_SHARED_PREF: "+e);
			}
...
class Intro_CONTAINS_SHARED_PREF extends IntroHook { 
	public void execute(Object... args) {
		...
		try {
			...
			Log.i("cloakdroidLog", "error in Intro_CONTAINS_SHARED_PREF: "+e);
		}
	}
}
